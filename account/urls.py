...
urlpatterns = [
    ...
    # changes for logout is done in base.html logout link
    ...
    path("password_reset/", auth_views.PasswordResetView.as_view(
        ...
        success_url='password_reset_email_confirm',#'/' at very start show url will start from root directory from there
